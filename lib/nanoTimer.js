...
NanoTimer.prototype.setInterval = function(task, args, interval, callback){
	...
	if(!this.intervalErrorChecked){
		...
		if(this.intervalType == 's'){
			this.intervalTime = Number(interval.slice(0, interval.length-1))* 1000000000;
		} else if(this.intervalType == 'm'){
			this.intervalTime = Number(interval.slice(0, interval.length-1)) * 1000000;
		} else if(this.intervalType == 'u'){
			this.intervalTime = Number(interval.slice(0, interval.length-1)) * 1000;
		} else if(this.intervalType == 'n'){
			this.intervalTime = Number(interval.slice(0, interval.length-1));
		} else {
...
NanoTimer.prototype.setTimeout = function(task, args, delay, callback){
	...
	if(delayType == 's'){
		var delayTime = Number(delay.slice(0, delay.length-1)) * 1000000000;
	} else if(delayType == 'm'){
		var delayTime = Number(delay.slice(0, delay.length-1)) * 1000000;
	} else if(delayType == 'u'){
		var delayTime = Number(delay.slice(0, delay.length-1)) * 1000;
	} else if(delayType == 'n'){
		var delayTime = Number(delay.slice(0, delay.length-1));
	} else {
